...
let cap = document.getElementById('capt').value;
var capFlag = 0;
if(cap)
  {
if(cap==check){
  capFlag =1;
  document.getElementById('capvalid').style="display:none;"
  document.getElementById('caperror').style="display:none;"
  document.getElementById("capt").style="border:3px solid green;"
  document.getElementById("lgoc").style="display: inline-block;"
}
else{
  document.getElementById('capvalid').style="display:block; color:red"
  document.getElementById('caperror').style="display:none;"
  document.getElementById("capt").style="border:3px solid red;"
  document.getElementById("lgoc").style="display: none;"
}
  }
  else{
    document.getElementById('caperror').style="display:block; color:red"
    document.getElementById('capvalid').style="display:none;"
    document.getElementById("capt").style="border:3px solid red;"
    document.getElementById("lgoc").style="display: none;"
  }
...
redirectvalue.addEventListener('click', function () {
                      if(nameFlag==1 && emailFlag==1 && phFlag == 1 && capFlag==1) {            
...
var check = document.getElementById('discap').innerHTML = makeid(5);
console.log(check)
